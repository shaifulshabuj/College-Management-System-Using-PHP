		...
		<?php 
			...
			if ($_SERVER["REQUEST_METHOD"] == "POST"){
					...
					$username = $_POST['id'];
						...
						$sql = "select * from student where fname ='$username' and email='$password'";
		...
		<div id="main" class="container">
			...
			<form method="post" action="#" class="form-horizontal">
			  <div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label"><i class="fa fa-user-o fa-3x" aria-hidden="true"></i>
</label>
				<div class="col-sm-10">
				  <input type="text" class="form-control" id="inputEmail3" name="id" placeholder="Student ID">
				</div>
			  </div>
